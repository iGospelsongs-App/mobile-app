...
const Login = ({ navigation }) => {
  ...
  const handlePostRequest = async () => {
    try {
      const response = await axios.post(apiUrl + "auth/signin/", formValues);
      ...
      AsyncStorage.setItem("user_profile", JSON.stringify(response.data.data));
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.wrapper}>
        ...
        <View style={styles.form}>
          ...
          <Text
            style={styles.forgot}
            onPress={() => navigation.navigate("forgot-pword")}
          >
            Forgot Password?
          </Text>
